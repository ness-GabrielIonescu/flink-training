...
public class HourlyTipsExercise {
    ...
    public JobExecutionResult execute() throws Exception {
        ...
        fares.assignTimestampsAndWatermarks(WatermarkStrategy.<TaxiFare>forMonotonousTimestamps()
                        .withTimestampAssigner((taxiFare, l) -> taxiFare.getEventTimeMillis()))
                ...
                .process(new ProcessWindowFunction<TaxiFare, Tuple3<Long, Long, Float>, Long, TimeWindow>() {
                    ...
                    public void process(Long key, ProcessWindowFunction<TaxiFare, Tuple3<Long, Long, Float>,
                        ...
                        collector.collect(Tuple3.of(context.window().getEnd(), key, sumOfTipsInWindow));
                    }
                })
                .windowAll(TumblingEventTimeWindows.of(Time.hours(1)))
                .reduce((result1, result2) -> result1.f2 > result2.f2 ? result1 : result2)
                .addSink(sink);
